...
const Flex = () => {
  ...
  return (
      ...
      >
        <View style={{ marginLeft:0}}>
          ...
          <View style={{backgroundColor: '', flexDirection:'row'}}>
            ...
            <Text style={{paddingStart: 6, color: 'gray', fontSize: 40, borderBottomColor: 'black', borderBottomWidth: 1}}>100.000</Text>
          </View>
        </View>
    ...
    <View
      ...
      >
            <Text style={{width:150, color: 'black', fontSize: 20}}>BYOND Pay</Text>
    ...
    <View
      ...
      >
          <View style={{backgroundColor: '', flexDirection:'column'}}>
            ...
            <Text style={{paddingStart: 6, color: 'gray', fontSize: 40, borderBottomColor: 'black', borderBottomWidth: 1, width: 320}}></Text>
          </View>
    </View>
